...
<p align="center">
  <img src="https://img.shields.io/badge/Версия-1.3.3-blue?style=for-the-badge" alt="Версия">
  <img src="https://img.shields.io/badge/Лицензия-AGPL--3.0-green?style=for-the-badge" alt="Лицензия">
...
- **Создавайте списки и управляйте ими** — организуйте игры, фильмы, сериалы, аниме, мангу, книги и музыку.
...
- **Сохранность данных** — полная возможность экспорта и импорта, никакой привязки к платформе.
- **Приватность** — никакой рекламы, трекеров или передачи данных третьим лицам.
- **Высокая производительность** — невероятно быстрый, оптимизированный Vue 3 / Vite и легкий бэкенд на Fastify.
- **Открытый исходный код** — изучайте, создавайте форки или хостите проект самостоятельно.
...
- **[Jikan API](https://jikan.moe/)**: бесплатный open-source API для БД MyAnimeList, используется для **Аниме** и **Манги**.
...
Распространяется под лицензией GNU Affero General Public License v3.0. Смотрите `LICENSE` для получения дополнительной информации.
