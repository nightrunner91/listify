...
export const useRecordsStore = defineStore('records', () => {
  const records = ref<LyRecords<LyRecord>>({
    games: [
      { id: 43465235347, title: 'Genshin Impact', score: 5, liked: true, label: 'playing_now' },
      { id: 845475685467, title: 'Minecraft', score: 4, liked: false, label: 'playing_now' },
      { id: 645547585734, title: 'Battlefield 4', score: 4, liked: true, label: 'completed' },
      { id: 434436542454, title: 'Assassin\'s Creed 4: Black Flag', score: 3, liked: false, label: 'dropped' },
      { id: 43465235347, title: 'Genshin Impact', score: 5, liked: true, label: 'playing_now' },
      { id: 845475685467, title: 'Minecraft', score: 4, liked: false, label: 'playing_now' },
      { id: 645547585734, title: 'Battlefield 4', score: 4, liked: true, label: 'completed' },
      { id: 434436542454, title: 'Assassin\'s Creed 4: Black Flag', score: 3, liked: false, label: 'dropped' },
