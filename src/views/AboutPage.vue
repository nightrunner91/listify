  ...
  <n-grid
    ...
    <n-grid-item span="1">
      ...
      <n-list>
        ...
        <n-list-item>
          <n-space :wrap-item="false" align="center">
            <n-icon size="24" :component="TypescriptIcon" />
            <n-text strong>Typescript</n-text>
          </n-space>
        </n-list-item>
        <n-list-item>
          <n-space :wrap-item="false" align="center">
            <n-icon size="24" :component="NaiveIcon" />
            <n-text strong>Naive UI</n-text>
          </n-space>
        </n-list-item>
      </n-list>
    </n-grid-item>
