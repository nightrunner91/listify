...
<template>
  <n-grid
    ...
    <n-grid-item span="6 m:5 l:4">
      ...
      <n-p>Listify is designed to track your favorite entertainment choices, whether it's games, films, anime, books, or anything else. It supports JSON collection import/export and can be accessed from any device via a browser's <n-a href="https://developer.mozilla.org/ru/docs/Web/API/Window/localStorage" target="_blank">localStorage</n-a>.</n-p>
