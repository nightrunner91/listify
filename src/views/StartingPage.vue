...
<template>
  <n-grid
    ...
    <n-grid-item span="6 m:5 l:4">
      ...
      <n-p>Listify is an open-source project that's still in development. If you have any suggestions or encounter any bugs, please feel free to contact us via <n-a href="https://t.me/nightrunner91" target="_blank">Telegram</n-a> or <n-a href="https://github.com/nightrunner91/listify/issues" target="_blank">open an issue</n-a> on Github.</n-p>
